...
namespace mesosclr.Native
{
    internal class NativeImports
    {
        ...
        public static class ExecutorDriver
        {
            ...
            public unsafe static extern IntPtr Initialize(long managedDriverId, ExecutorInterface* executorInterface);
        ...
        public static class SchedulerDriver
        {
            ...
            public unsafe static extern IntPtr Initialize(long managedDriverId, SchedulerInterface* schedulerInterface, IntPtr frameworkInfo,
